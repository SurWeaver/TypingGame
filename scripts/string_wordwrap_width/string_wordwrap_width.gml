...
//
///@args   string      text to word wrap, string
///@args   width       maximum pixel width before a line break, real
///@args   break       line break characters to insert into text, string
///@args   split       split words that are longer than the maximum, bool
//
